...
# Async Graph Reasoning System Demo Runner

echo "=== Async Graph Reasoning System Demo ==="
...
# Run the async demo
echo "Starting async demo..."
mvn exec:java -Dexec.mainClass="com.tog.graph.demo.AsyncGraphReasoningDemo" -q
